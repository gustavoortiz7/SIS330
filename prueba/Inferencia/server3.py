                ...
                for kpt in keypoints:
                    for j, pt in enumerate(kpt):
                        ...
                        if j in [5, 6, 7, 8, 9, 10]:
                            ...
                            cv2.circle(frame, (x, y), radius=10, color=(0, 255, 0), thickness=-1)  # Green for other keypoints
...
async def process_video(video: UploadFile = File(...)):
    ...
    yolo_detector = YOLO("C:\MI-CARRERA\Semestre7\SIS330\PROYECTO\yolov8s-pose.pt")
    try:
